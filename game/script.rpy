init:
    ...
    define lebanc    = Character("LeBlanc")
...
label brentFirst:
    ...
    allan "Wait, at least here us out!"
    ...
    # Choices:
    # 1. Write about Clark, the queen’s story is overrated.
    # 2. Write about the queen, I might get a chance to meet her!
    # --(If "Write about Clark" was chosen)----------------------------------------------------
    ...
    # --(If "Write about the queen" is chosen)------------------------------------------------
    ...
    # --(If "Write about the queen" was chosen)---------------------------------------------
    ...
    "Could I...?"
    # Choices:
    # 1. Topple the barrels.
    # 2. Leave them alone.
    # --(If "Topple barrels" was chosen)
    ...
    "GAME OVER"
    # -(If "Leave them alone" was chosen)----------------------------------------------------
    ...
    ghepetto "I; sure you’ve seen my little masterpiece."
    ...
    # --(After interaction or if "Bag" was chosen)---------------------------------------
    ...
    # --(If the player is on the "Lewis Route", or the "Accomplice Route")------------
    ...
    # 2. The Closet
    # --( If "Outside the window" is chosen)---------------------------------------------------
    ...
    "She retracts her and leaves the room."
    ...
    "My dad will get pissed, but it’s for good reason!"
    ...
    "He takes us to a trek until we reach an abandoned building."
    ...
    "Forward again."
    "And then a left."
    "God, imagine doing this backwards."
    ...
    maybelle "Because I knew he didn’t want anyone else. He left a note writing about what the Hawkins and the others had done to him."
    maybelle "He couldn’t live with the guilt of not stopping them, but I know I he also wanted revenge."
    maybelle "He finished his robots, the ones chasing you two, and left it at his workshop.If there was anyone who would enact what he wanted, I knew it would be me."
    ...
    brent "What the..."
    maybelle "I did say robots, didn’t I?"
    ...
    # Choices:
    # 1. Right, Right, Left, Forward, Forward, Left.
    # 2. Left, Left, Right, Forward, Forward, Right.
    # --(If "Right, Right, Left, Forward, Forward, Left." was chosen)--------------------
    "We take a right-"
    "Shit!"
    "It’s blocked!"
    ...
    "GAME OVER."
    # --(If "Left, Left, Right, Forward, Forward, Right." was chosen)--------------------
    "Right, reverse."
    ...
    "She crouches down, and I hear a hic from her."
    ...
    "Epilogue"
    "Two months have passed and the Ghepetto Killer is behind bars."
    "The identity of the killer is Maybelle Bradley, sister of inventor Lewis Bradley."
    "The many missing capitalist have been confirmed to have been dead and killed by Maybelle Bradley via the robots her brother created."
    "Maybelle Bradley will be behind bars until her sentence has been decided."
    "...."
    ...
    "We hear a door slam.Allan: "Wait-""
    brent "Allan, look!"
    "Brent points to the platform Maybelle was standing on. Specifically, he’s pointing to the metal column."
    "Wait no, it’s more of a cylinder."
    "With a cone tope and a pipe sticking out of it."
    ...
    brent "What, but Al-"
    allan "Just do it! We don’t have time!"
    "Brent nods, and runs towards"

    "A new article written by Allan (the protagonist) is about to be published but Allan is disappointed with his work."
    "He wants to start writing novels but he can't get a greenlight nor any ideas."
    "He's working in a down-in-the-dumps publishing company that barely gets any readers."
    "His boss comes to him to congratulate on his new article and when Allan asks if there's any extra work to do,"
    "his boss tells him he can just have the day off much to his dismay.
    Allan then returns home to his apartment."
